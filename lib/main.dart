...
Widget build(BuildContext context) {
  return MultiProvider(
      providers: [...ApplicationProvider.instance.dependItems], // Added to satisfy the 'future' parameter requirement
      child: FutureBuilder(
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData.dark().copyWith(
        ...
        dialogBackgroundColor: secondaryColor, // Changed from buttonColor to dialogBackgroundColor
        // buttonColor: greenColor, // Removed as it's not a valid property of ThemeData
